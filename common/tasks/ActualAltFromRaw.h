...
#ifndef TASKS_ACTUALALTFROMRAW_H_
#define TASKS_ACTUALALTFROMRAW_H_
...
class ActualAltFromRaw:public RobotTask
{
	private:
	...
	public:
		ActualAltFromRaw(const char *name, DataAccess<Task_status>& Task_access, DataAccess<NGC_status>& NGC_access) :RobotTask(name)
		{
		...
		virtual void compute()
		{
			...
			ngc_status.pose.actual.altitude=ngc_status.pose.raw.altitude;
...
#endif /* TASKS_ACTUALALTFROMRAW_H_ */
