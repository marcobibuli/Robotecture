...
class NetworkManager
{
	public:
		...
		uint16 USBL_POS_SIM_PORT_IN;
		uint16 USBL_POS_SIM_PORT_OUT;
		uint16 USBL_POS_PORT_IN;
		uint16 USBL_POS_PORT_OUT;
		uint16 USBL_HMI_POS_PORT_IN;
		uint16 USBL_HMI_POS_PORT_OUT;
		uint16 USBL_HMI_CHK_PORT_IN;
		uint16 USBL_HMI_CHK_PORT_OUT;
		...
		uint16 USBL_CHK_PORT_IN;
		uint16 USBL_CHK_PORT_OUT;
		...
		uint16 CMD_HMI_PORT_IN;
		uint16 CMD_HMI_PORT_OUT;
