...
class NetworkManager
{
	public:
		...
		uint16 FOG_SIM_ROBOT_PORT_IN;
		uint16 FOG_SIM_ROBOT_PORT_OUT;
		...
		uint16 GPS_AHRS_SIM_ROBOT_PORT_IN;
		uint16 GPS_AHRS_SIM_ROBOT_PORT_OUT;
		uint16 GPS_AHRS_PORT_IN;
		uint16 GPS_AHRS_PORT_OUT;
		...
		uint16 TLM_SIM_PORT_IN;
		uint16 TLM_SIM_PORT_OUT;
